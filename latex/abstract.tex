...
\todo[inline]{
  LessPM seeks to address these deficiencies with WebAuthn's sophisticated
  authentication methods through asymmetric cryptography to provide a
  secure authentication experience with the help of user-owned devices such as
  smartphones or hardware authenticator devices.
